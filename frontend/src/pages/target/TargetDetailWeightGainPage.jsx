      ...
      <div className="w-1/2 flex flex-row gap-6 px-6 mb-6">
        <LocalizationProvider dateAdapter={AdapterMoment}>
          <DemoContainer components={["DateTimePicker"]}>
            <DateTimePicker label={t("gain_weight.time_start")} />
          </DemoContainer>
        </LocalizationProvider>
        <LocalizationProvider dateAdapter={AdapterMoment}>
          <DemoContainer components={["DateTimePicker"]}>
            <DateTimePicker label={t("gain_weight.time_end")} />
          </DemoContainer>
        </LocalizationProvider>
      </div>
      <div className="w-1/2 flex flex-row gap-6 px-6 mb-6">
        <TextField type="number" label={t("gain_weight.init_weight")} />
        <TextField type="number" label={t("gain_weight.target_end")} />
      </div>

      <div className="w-1/2 flex flex-row gap-6 px-6 mb-24">
        <TextField label={t("gain_weight.curr_weight")} />
        <Button variant="contained">{t("gain_weight.save")}</Button>
      </div>
    </div>
  );
}
